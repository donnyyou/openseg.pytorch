...
class ProxyAspOCNet(nn.Module):
    def __init__(self, configer):
        self.inplanes = 128
        super(ProxyAspOCNet, self).__init__()
        ...
        from lib.models.modules.proxy_oc_block import ProxyOC_Module
        self.oc_module = Proxy_ASP_OC_Module(in_channels=512, out_channels=512,
