...
class ProxyBaseOCNet(nn.Module):
    def __init__(self, configer):
        self.inplanes = 128
        super(ProxyBaseOCNet, self).__init__()
        ...
        from lib.models.modules.proxy_oc_block import ProxyOC_Context_Module
        self.oc_module = ProxyOC_Context_Module(in_channels=512, out_channels=512,
