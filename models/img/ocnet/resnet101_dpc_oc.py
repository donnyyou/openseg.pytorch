...
from models.modules.oc_modules.dpc_oc_block import DPC_OC_Module
...
class ResNetDpcOCDsn(nn.Module):
    def __init__(self, configer):
        self.inplanes = 128
        super(ResNetDpcOCDsn, self).__init__()
