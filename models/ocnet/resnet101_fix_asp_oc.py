...
from models.modules.oc_modules.asp_oc_block import Fix_ASP_OC_Module
...
class ResNnet101FixAspOCDsn(nn.Module):
    def __init__(self, configer):
        self.inplanes = 128
        super(ResNnet101FixAspOCDsn, self).__init__()
