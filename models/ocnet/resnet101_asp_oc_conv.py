...
from models.modules.oc_modules.asp_oc_block import ASP_OC_Conv_Module
...
class ResNet101AspOCConvDsn(nn.Module):
    def __init__(self, configer):
        self.inplanes = 128
        super(ResNet101AspOCConvDsn, self).__init__()
