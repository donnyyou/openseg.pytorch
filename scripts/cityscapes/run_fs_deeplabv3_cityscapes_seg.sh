...
if [ "$1"x == "train"x ]; then
  ${PYTHON} -u main.py --configs configs/cityscapes/fs_deeplabv3_cityscapes_seg.json --drop_last y \
  ...
  ${PYTHON} -u main.py --configs configs/cityscapes/fs_deeplabv3_cityscapes_seg.json \
  ...
  cd lib/val/scripts
  ${PYTHON} -u cityscapes_evaluator.py --configs_file ../../../configs/cityscapes/fs_deeplabv3_cityscapes_seg.json \
