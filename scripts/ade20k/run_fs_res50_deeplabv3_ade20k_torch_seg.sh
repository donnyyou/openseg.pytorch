...
if [ "$1"x == "train"x ]; then
  ${PYTHON} -u main.py --hypes hypes/ade20k/fs_deeplabv3_ade20k_torch_seg.json --drop_last y \
  ...
  ${PYTHON} -u main.py --hypes hypes/ade20k/fs_deeplabv3_ade20k_torch_seg.json \
  ...
  cd val/scripts
  ${PYTHON} -u ade20k_evaluator.py --hypes_file ../../hypes/ade20k/fs_deeplabv3_ade20k_torch_seg.json \
