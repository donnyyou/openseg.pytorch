...
LOG_FILE="./log/ade20k/fs_resnet50_baseocnet_ade20k_seg_120.log"
...
if [ "$1"x == "train"x ]; then
  ${PYTHON} -u main.py --hypes hypes/ade20k/fs_baseocnet_ade20k_seg.json --drop_last y \
                       ...
                       --backbone deepbase_resnet50_dilated8 --checkpoints_name fs_resnet50_baseocnet_ade20k_seg_120 \
  ...
  ${PYTHON} -u main.py --hypes hypes/ade20k/fs_baseocnet_ade20k_seg.json --drop_last y \
                       ...
                       --data_dir /msravcshare/v-ansheng/DataSet/ADE20K \
                       --backbone deepbase_resnet50_dilated8 --checkpoints_name fs_resnet50_baseocnet_ade20k_seg_120 \
                       --resume_continue y --resume ./checkpoints/ade20k/fs_resnet50_baseocnet_ade20k_seg_120_latest.pth \
                       --pretrained ./pretrained_model/resnet50-imagenet.pth  >> $LOG_FILE 2>&1
