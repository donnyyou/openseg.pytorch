...
CHECKPOINTS_NAME="fs_res50_aspocnet_ade20k_torch_seg"$2
...
if [ "$1"x == "train"x ]; then
  ${PYTHON} -u main.py --configs configs/ade20k/fs_ocnet_ade20k_torch_seg.json --drop_last y \
  ...
  ${PYTHON} -u main.py --configs configs/ade20k/fs_ocnet_ade20k_torch_seg.json \
  ...
  cd lib/val/scripts
  ${PYTHON} -u ade20k_evaluator.py --configs_file ../../../configs/ade20k/fs_ocnet_ade20k_torch_seg.json \
