...
CHECKPOINTS_NAME="fs_resnet50_pspnet_ade20k_seg_120_10"
...
if [ "$1"x == "train"x ]; then
  ${PYTHON} -u main.py --hypes hypes/ade20k/fs_pspnet_ade20k_seg.json --drop_last y \
                       ...
                       --backbone ${BACKBONE} --model_name ${MODEL_NAME} --bb_mult 10 \
  ...
  ${PYTHON} -u main.py --hypes hypes/ade20k/fs_pspnet_ade20k_seg.json --drop_last y \
                       ...
                       --data_dir ${DATA_DIR} --loss_type ${LOSS_TYPE} --bb_mult 10 \
