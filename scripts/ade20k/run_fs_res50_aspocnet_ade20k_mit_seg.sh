...
CHECKPOINTS_NAME="fs_res50_aspocnet_ade20k_mit_seg"$2
...
if [ "$1"x == "train"x ]; then
  ${PYTHON} -u main.py --hypes hypes/ade20k/fs_ocnet_ade20k_mit_seg.json --drop_last y \
                       --phase train --gathered n --loss_balance y --log_to_file n --cudnn n \
  ...
  ${PYTHON} -u main.py --hypes hypes/ade20k/fs_ocnet_ade20k_mit_seg.json \
  ...
  cd val/scripts
  ${PYTHON} -u ade20k_evaluator.py --hypes_file ../../hypes/ade20k/fs_ocnet_ade20k_mit_seg.json \
