...
CHECKPOINTS_NAME="fs_resnet50_aspocnetv4_ade20k_seg_80_576"
...
if [ "$1"x == "train"x ]; then
  ${PYTHON} -u main.py --hypes hypes/ade20k/fs_ocnet_ade20k_seg.json --drop_last y \
  ...
  cd val/scripts
  ${PYTHON} -u ade20k_evaluator.py --hypes_file ../../hypes/ade20k/fs_ocnet_ade20k_seg.json \
