...
LOG_FILE="./log/cityscape/fs_aspocnet_cityscape_seg.log"
...
if [ "$1"x == "train"x ]; then
  ...
  $PYTHON -u main.py --hypes hypes/cityscape/fs_aspocnet_cityscape_seg.json --phase debug --gpu 0

elif [ "$1"x == "test"x ]; then
  $PYTHON -u main.py --hypes hypes/cityscape/fs_aspocnet_cityscape_seg.json --phase test --gpu 0 --resume $2
  cd val/scripts
