...
CHECKPOINTS_NAME="fs_mul_grid_fastaspocnet_cityscape_seg"$2
PRETRAINED_MODEL="./pretrained_model/resnet101-imagenet.pth"
CONFIG="configs/cityscape/mul_grid_fs_ocnet_cityscape_seg.json"
MAX_ITERS=40000
...
if [ "$1"x == "train"x ]; then
  ...
  cd lib/val/scripts
  ${PYTHON} -u cityscape_evaluator.py --configs_file ../../../${CONFIG} \
