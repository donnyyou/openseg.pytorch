...
CHECKPOINTS_NAME="fs_pspnet_cityscape_seg"$2
...
if [ "$1"x == "train"x ]; then
  ${PYTHON} -u main.py --configs configs/cityscape/fs_pspnet_cityscape_seg.json --drop_last y \
  ...
  ${PYTHON} -u main.py --configs configs/cityscape/fs_pspnet_cityscape_seg.json \
  ...
  cd lib/val/scripts
  ${PYTHON} -u cityscape_evaluator.py --configs_file ../../../configs/cityscape/fs_pspnet_cityscape_seg.json \
